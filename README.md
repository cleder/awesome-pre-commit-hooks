...
- [jscpd](https://github.com/kucherenko/jscpd) — Copy/paste detector for programming source code, supports 223 formats. AI-ready with token-efficient reporter, skill and MCP server.
...
- [darnlink](https://github.com/txemi/darnlink) — Auto-healing Markdown links — anchor links to a UUID so they survive refactors: repair moved links, robustify plain ones. No database, editor-agnostic.
...
- [behave-doctor](https://github.com/MathiasPaulenko/behave-doctor) — Static analysis and diagnostics for Behave BDD suites. Detects unused step definitions, undefined steps, oversized features, inconsistent tags, and circular import dependencies — without executing a single test.
- [behave-format](https://github.com/MathiasPaulenko/behave-format) — The opinionated formatter for Behave .feature files. Like Black, but for Gherkin.
...
- [djLint](https://github.com/djlint/djLint) — ✨ HTML Template Linter and Formatter. Django, Jinja, Askama, Tera, Liquid, Nunjucks, Twig, Handlebars, Mustache, GoLang, Angular
